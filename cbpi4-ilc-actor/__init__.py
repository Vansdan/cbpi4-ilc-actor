...
@parameters([
    ...
    Property.Text(label="Target URL On", configurable=True,
                  description="Target url for state on. Must include a uri scheme (https://...)"),
    #Property.Text(label="Request Body On", configurable=True,
    #              description="This request body is passed in the corresponding on request"),
    Property.Text(label="Target URL Off", configurable=True,
                  description="Target url for state off. Must include a uri scheme (https://...)"),
    #Property.Text(label="Request Body Off", configurable=True,
    #              description="This request body is passed in the corresponding off request"),
    #Property.Text(label="Basic Authentication Username", configurable=True,
    #             description="Username used for basic authentication"),
    #Property.Text(label="Basic Authentication Password", configurable=True,
