...
class ILCActor(CBPiActor):
    ...
    async def start_request(self, onoff):
        ...
        logger.info("ILCActor type=request_start onoff=%s url=\"%s\" payload=\"%s\" method_getpost=%s user=%s" % (onoff, url, payload_logtext, self.httpmethod_get, basic_auth_logtext))
